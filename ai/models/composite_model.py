...
from utils.composite_model_utils import *
...
class f_model(nn.Module):
    ...
    def __init__(self, freeze_param=False, inter_dim=512, num_classes=20, model_path=None):
        ...
        state = torch.load(COMPOSITE_MODEL_PATH)
        if state:
